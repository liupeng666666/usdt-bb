(function() {
    function l(a) {
        var b;
        if ("object" !== typeof a || a.constructor && !a.hasOwnProperty("constructor") && !(a.constructor.prototype || {}).hasOwnProperty("isPrototypeOf"))
            return !1;
        for (b in a)
            ;
    ...
    function g() {
        var a, b, c, e, d, f = arguments[0] || {}, h = 1, g = arguments.length, k = !1;
        ...
        for (; h < g; h++)
            if (null != (a = arguments[h]))
                for (b in a)
                    c = f[b],
                    e = a[b],
                    f !== e && (k && e && (l(e) || (d = Array.isArray(e))) ? (d ? (d = !1,
                    c = c && Array.isArray(c) ? c : []) : c = c && l(c) ? c : {},
                    f[b] = jQuery.extend(k, c, e)) : void 0 !== e && (f[b] = e));
        return f
    }
    function m(a) {
    ...
    if (!window.TradingView) {
        var n = {
          ...
          , d = {
            ...
            HOLLOW_CANDLES: 9,
            version: function() {
                return "1.9 (internal id 38b68957 @ 2017-03-16 23:17:25.484112)"
            },
            gEl: function(a) {
            ...
            css: function(a) {
                ...
                c.type = "text/css";
                c.styleSheet ? c.styleSheet.cssText = a : (a = document.createTextNode(a),
                c.appendChild(a));
                b.appendChild(c)
            },
            ...
            widget: function(a) {
                ...
                a.preset && (a = a.preset,
                n[a] ? (a = n[a],
                this.options.disabledFeatures = 0 < this.options.disabledFeatures.length ? this.options.disabledFeatures.concat(a.disabledFeatures) : a.disabledFeatures,
                this.options.enabledFeatures = 0 < this.options.enabledFeatures.length ? this.options.enabledFeatures.concat(a.enabledFeatures) : a.enabledFeatures) : console.warn("Unknown preset: `" + a + "`"));
        ...
        d.widget.prototype = {
            ...
            _autoResizeChart: function() {
                this.options.fullscreen && (d.gEl(this.id).style.height = 400 + "px") //修改 window.innerHeight
            },
            create: function() {
